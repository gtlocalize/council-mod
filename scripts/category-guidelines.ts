/**
 * Condensed Category Guidelines for LLM Prompts
 * 
 * User-first safety approach - these definitions are sent to LLMs during 
 * moderation and QA audits. Prioritizes user safety over industry conventions.
 * 
 * ~850 tokens - fits in prompts without overwhelming context.
 * Full definitions: CATEGORY_DEFINITIONS.md
 */

export const CONDENSED_GUIDELINES = `
...
EXPLICIT vs IMPLIED THREATS (both are threats):
...
5. hate_speech
   ...
   - Examples:
     ...
     ? Other reclaimed slurs by marginalized groups → ESCALATE if uncertain
...
/**
 * Token count estimate: ~850 tokens
 * Covers all 11 categories with user-first safety distinctions
 * Matches CATEGORY_DEFINITIONS.md v1.1.0 principles
 */

export const GUIDELINES_TOKEN_ESTIMATE = 850;
